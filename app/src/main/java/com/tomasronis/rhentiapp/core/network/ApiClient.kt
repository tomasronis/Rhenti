...
interface ApiClient {
    ...
    suspend fun clearBadge(@Path("threadId") threadId: String): Map<String, Any>
    ...
    suspend fun proposeAlternativeTimes(@Body request: Map<String, Any>): Map<String, Any>
    ...
    suspend fun getTwilioAccessToken(@Body request: Map<String, Any>): Map<String, Any>

    @GET("/phone-tracking/ownercontactlogs/{superAccountId}")
    suspend fun getCallLogs(@Path("superAccountId") superAccountId: String): List<Map<String, Any>>

    @POST("/phone-tracking/callLog")
    suspend fun recordCallLog(@Body request: Map<String, Any>): Map<String, Any>
    ...
    @PUT("/users")
    suspend fun updateUserProfile(@Body request: Map<String, Any>): Map<String, Any>

    @POST("/users")
    suspend fun batchGetUsers(@Body userIds: List<String>): List<Map<String, Any>>
    ...
    suspend fun getProperty(@Path("propertyId") propertyId: String): Map<String, Any>
    ...
    @GET("/appVersion")
    suspend fun getAppVersion(): Map<String, Any>
}
